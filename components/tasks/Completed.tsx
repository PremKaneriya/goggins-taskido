    ...
    <div className="flex min-h-screen bg-gray-100">
      ...
      <main className="flex-1 p-4 sm:p-6 md:p-8">
        <div className="mx-auto max-w-4xl w-full">
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-6 sm:mb-8">Completed Tasks</h1>
          ...
          {loading ? (
            ...
            <div className="bg-white rounded-lg sm:rounded-xl shadow-lg p-6 sm:p-8 text-center">
              <p className="text-gray-600 text-sm sm:text-base">No completed tasks found.</p>
            </div>
          ) : (
